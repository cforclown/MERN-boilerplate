...
export const REST_API_AUTH_ROOT_PATH = import.meta.env.VITE_REST_API_AUTH_ROOT_PATH;
...
export const AUTH_ENDPOINT = `${REST_API_BASE_URL}/${REST_API_AUTH_ROOT_PATH}/${REST_API_VERSION}}`;
